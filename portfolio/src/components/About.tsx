...
const About = () => {
  return (
        <section 
        id='about' 
        className="min-h-screen bg-gray-800 dark:bg-gray-300 flex items-center px-4 sm:px-8 md:px-12 lg:px-16 xl:px-28 py-12 sm:py-20 overflow-hidden"
        >
        <div className="container mx-auto">
            ...
            <div className="lg:w-1/2 order-2 lg:order-1 animate-fadeInLeft">
                ...
                <li className="ms-6">            
                    ...
                    <RiComputerFill className="text-gray-100 dark:text-gray-800 text-xl"/>
                    <h3 className="font-bold text-lg sm:text-xl leading-tight dark:text-gray-800 text-gray-100">Frontend Development</h3>
                    </div>
                    <p className="text-sm sm:text-base text-gray-600">React, TypeScript, Tailwind CSS</p>
                </li>
                
                <li className="ms-6">
                    <span className="absolute flex items-center justify-center w-4 h-4 rounded-full -start-2 bg-[var(--primary)]"></span>
                    <div className="flex justify-start gap-4 mb-2 items-center">
                    <RiCodeBoxFill className="text-gray-100 dark:text-gray-800 text-xl"/>
                    <h3 className="font-bold text-lg sm:text-xl leading-tight text-gray-100 dark:text-gray-800">Backend Development</h3>
                    </div>
                    <p className="text-sm sm:text-base text-gray-600">Node.js, Express, Spring (Java), Django (Python)</p>
                </li>

                <li className="ms-6">
                    <span className="absolute flex items-center justify-center w-4 h-4 rounded-full -start-2 bg-[var(--primary)]"></span>
                    <div className="flex justify-start gap-4 mb-2 items-center">
                    <RiDatabase2Fill className="text-gray-100 dark:text-gray-800 text-xl"/>
                    <h3 className="font-bold text-lg sm:text-xl leading-tight text-gray-100 dark:text-gray-800">Database & DevOps</h3>
                    </div>
                    <p className="text-sm sm:text-base text-gray-600">MongoDB, PostgreSQL, Docker, Git</p>
                </li>
                </ol>
            </div>
