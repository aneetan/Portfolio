...
const Hero = () => {
  return (
    <section id='home' className="min-h-screen bg-gray-800 flex items-center px-4 sm:px-8 md:px-12 lg:px-28 py-20 overflow-hidden">
    <div className="container mx-auto">
        ...
        {/* Image Content */}
        <div className="md:w-1/2 order-1 md:order-2 flex justify-center md:justify-end transition-all duration-1000 delay-150 z-10">
